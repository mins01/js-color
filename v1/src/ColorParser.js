...
export default class ColorParser{
	...
	static validIsNumber(v=null){ return (!Number.isFinite(v))?null:v; }

	static valid0to255(v=null){ return (!Number.isFinite(v) || v<0 || v>255)?null:v; }
	static valid0to360(v=null){ return (!Number.isFinite(v) || v<0 || v>360)?null:v; }
	static valid0to100(v=null){ return (!Number.isFinite(v) || v<0 || v>100)?null:v; }
	static valid0to1(v=null){ return (!Number.isFinite(v) || v<0 || v>1)?null:v; }

	static validRed(v){ return this.valid0to255(v); }
	static validGreen(v){ return this.valid0to255(v); }
	static validBlue(v){ return this.valid0to255(v); }
	static validHue(v){ return this.valid0to360(v); }
	static validSaturation(v){ return this.valid0to100(v); }
	static validLightness(v){ return this.valid0to100(v); }
	static validAlpha(v){ return this.valid0to1(v); }
