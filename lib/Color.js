...
class Color{	
	...
	setR(v){ if(ColorParser.validIsNumber(v)===null){ throw new Error(`Red must be a number. (${v})`); } this.#r = v; }
	setG(v){ if(ColorParser.validIsNumber(v)===null){ throw new Error(`Green must be a number. (${v})`); } this.#g = v; }
	setB(v){ if(ColorParser.validIsNumber(v)===null){ throw new Error(`Blue must be a number. (${v})`); } this.#b = v; }
	setA(v){ if(ColorParser.validIsNumber(v)===null){ throw new Error(`Alpha must be a number. (${v})`); } this.#a = v; }
